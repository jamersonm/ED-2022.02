...
int main()
{
    ...
    printf("Informe um valor qualquer para verificar se existe multiplo: ");
    scanf("%i",&k);
    printf("Valor da soma dos multiplos de %i: %i\n", k, SomaInteirosMultiplosDoVetor(n,v,k));
